...
// I made this based on this tutorial, check it out!
...
obtainData = () => {
	...
	if (currentValue.length < 2) {
		document.getElementById("user_input").value = social_network === "twitter" ? `@${MY_TWITTER_USER}` : MY_TWITTER_USER;
...
document.getElementById("user_input").addEventListener("focus", () => {
	if (document.getElementById("user_input").value === `@${MY_TWITTER_USER}`) 
